  ...
  return (
    <div>
      ...
      <main className='max-w-6xl mx-auto p-10 border'>
        ...
        <p className='pb-5'>
          By adding an item to the marketplace, you're essentially Mining an NFT
        ...
        <div className='flex flex-col justify-center items-center md:flex-row md:space-x-5 pt-5'>
          ...
          >
            ...
            <button
              type='submit'
              className='bg-blue-600 font-bold text-white rounded-full py-4 px-10 w-56 mx-auto md:ml-auto'
            >
              Add/Mint Item
            </button>
          </form>
